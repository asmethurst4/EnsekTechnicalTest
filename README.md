...
As I was testing I made a note of numerous bugs, most of which being text issues. These are as follows.
...
I did not get around to checking Register or Log In screens so I can't comment on those. If I was raising these properly for a developer to look at, they would be as follows:
...
- (Would provide an image of the screen for this section in an actual report)
...
- Another bug I found was the ability to add orders with duplicate ID in the API. This means you can only return the most recent one with that ID.
